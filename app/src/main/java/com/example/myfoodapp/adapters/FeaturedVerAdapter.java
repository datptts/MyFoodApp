...
public class FeaturedVerAdapter extends RecyclerView.Adapter<FeaturedVerAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.detailed_imgv);
            name = itemView.findViewById(R.id.detailed_namev);
            description = itemView.findViewById(R.id.detailed_desv);
            rating = itemView.findViewById(R.id.detailed_ratingv);
            timing = itemView.findViewById(R.id.detailed_timingv);
